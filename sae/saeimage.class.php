...
class SaeImage extends SaeObject
{
     ...
     * <pre>
     *    name,常量,字体名称，支持的字体：SAE_SimSun(宋体,默认)、SAE_SimKai(楷体)...
     *    weight,字体宽度,int
     *    size，字体大小,int
     *    color,字体颜色,black(默认),red,blue...;
     *    raise,浮雕效果0,1,2. 0不设置浮雕(默认)，1凸出，2凹陷
     *    stretch,常量,字体伸缩: SAE_Normal(默认),SAE_UltraCondensed,SAE_ExtraCondensed,SAE_Condensed,
     *        SAE_SemiCondensed,SAE_SemiExpanded,SAE_Expanded,SAE_ExtraExpanded,SAE_UltraExpanded
     *    style,常量,字体风格：SAE_Normal(默认),SAE_Italic,SAE_Oblique
     * </pre>
     *
     * @return bool
     * @author Lijun
