...
if(!fn||!fn.call){Y.log(type+" attach call failed, invalid callback","error","event");return false;}
...
if(!el){Y.log("unable to attach event "+type,"warn","event");return false;}
