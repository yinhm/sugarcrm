...
return this;}
if(!StyleSheet.isValidSelector(sel)){Y.log("Invalid selector '"+sel+"' passed to set (ignoring).",'error','StyleSheet');return this;}
...
catch(e){Y.log('Error assigning property "'+prop+'" to "'+css[prop]+"\" (ignored):\n"+e.message,'warn','StyleSheet');}}}
