...
else{Y.log("Could not format data "+Y.dump(data)+" from type Number","warn","datatype-number");return(LANG.isValue(data)&&data.toString)?data.toString():"";}}});},'3.0.0');YUI.add('datatype-number',function(Y){},'3.0.0',{use:['datatype-number-parse','datatype-number-format']});